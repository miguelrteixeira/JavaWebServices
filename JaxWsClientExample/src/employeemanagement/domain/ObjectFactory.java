 ...
 * generated in the employeemanagement.domain package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetEmployeeById_QNAME = new QName("http://domain.employeemanagement/", "getEmployeeById");
    private final static QName _GetEmployeeByIdResponse_QNAME = new QName("http://domain.employeemanagement/", "getEmployeeByIdResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: employeemanagement.domain
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://domain.employeemanagement/", name = "getEmployeeById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://domain.employeemanagement/", name = "getEmployeeByIdResponse")
